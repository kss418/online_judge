...
export function normalizeUserSummaryResponse(payload){
  return {
...
export function normalizePublicUserListResponse(response){
  return {
    users: normalizeArray(response?.users).map(normalizePublicUserListUser)
  }
}

export function normalizeUserSubmissionStatisticsResponse(payload){
...
export function normalizeSolvedProblemsResponse(payload){
  return {
...
export function normalizeWrongProblemsResponse(payload){
  return {
...
export function normalizeSubmissionBanResponse(payload){
...
export function normalizeAdminUserListResponse(response){
  return {
