...
namespace testcase_service{
    std::expected<problem_dto::testcase, service_error> create_testcase(
    ...
    std::expected<void, service_error> delete_testcase(
        db_connection& connection,
        const problem_dto::testcase_ref& testcase_reference_value
    );

    std::expected<void, service_error> delete_all_testcases(
        db_connection& connection,
        const problem_dto::reference& problem_reference_value
    );

    std::expected<problem_dto::testcase_count, service_error> replace_testcases(
        db_connection& connection,
        const problem_dto::reference& problem_reference_value,
