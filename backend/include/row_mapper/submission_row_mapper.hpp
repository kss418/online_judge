...
namespace submission_row_mapper{
    submission_dto::history map_history_row(const pqxx::row& submission_history_row);
    submission_dto::history_list map_history_result(
        const pqxx::result& submission_history_result
    );
    submission_dto::source_detail map_source_detail_row(
        const pqxx::row& submission_source_row
    );
    submission_dto::detail map_detail_row(const pqxx::row& submission_detail_row);
    submission_dto::status_snapshot map_status_snapshot_row(
        const pqxx::row& submission_status_row
    );
    std::vector<submission_dto::status_snapshot> map_status_snapshot_result(
    ...
    submission_dto::summary map_summary_row(const pqxx::row& submission_summary_row);
