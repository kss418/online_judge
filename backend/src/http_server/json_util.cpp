...
boost::json::object json_util::make_user_permission_object(
    std::int64_t user_id,
...
boost::json::array json_util::make_supported_language_array(
...
boost::json::object json_util::make_supported_language_list_object(
    std::span<const language_util::supported_language> supported_language_values
){
    boost::json::object response_object;
