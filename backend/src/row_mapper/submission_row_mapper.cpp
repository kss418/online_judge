...
submission_response_dto::history submission_row_mapper::map_history_row(
    const pqxx::row& submission_history_row
){
    submission_response_dto::history history_value;
...
submission_response_dto::history_list submission_row_mapper::map_history_result(
    const pqxx::result& submission_history_result
){
    submission_response_dto::history_list history_values;
...
submission_response_dto::source_detail submission_row_mapper::map_source_detail_row(
    const pqxx::row& submission_source_row
){
    submission_response_dto::source_detail source_detail_value;
...
submission_response_dto::detail submission_row_mapper::map_detail_row(
    const pqxx::row& submission_detail_row
){
    submission_response_dto::detail detail_value;
...
submission_response_dto::status_snapshot submission_row_mapper::map_status_snapshot_row(
    const pqxx::row& submission_status_row
){
    submission_response_dto::status_snapshot snapshot_value;
...
std::vector<submission_response_dto::status_snapshot> submission_row_mapper::map_status_snapshot_result(
    const pqxx::result& submission_status_result
){
    std::vector<submission_response_dto::status_snapshot> snapshot_values;
...
std::expected<submission_status, repository_error> submission_row_mapper::map_submission_status_row(
    ...
    const auto submission_status_opt =
        parse_submission_status(*submission_status_string_opt);
...
submission_response_dto::summary submission_row_mapper::map_summary_row(
    const pqxx::row& submission_summary_row
){
    submission_response_dto::summary summary_value;
...
std::vector<submission_response_dto::summary> submission_row_mapper::map_summary_result(
    const pqxx::result& submission_summary_result
){
    std::vector<submission_response_dto::summary> summary_values;
...
submission_domain_dto::leased_submission submission_row_mapper::map_leased_submission_row(
    const pqxx::row& submission_queue_row
){
    submission_domain_dto::leased_submission leased_submission_value;
