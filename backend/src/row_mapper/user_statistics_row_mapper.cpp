...
user_statistics_dto::submission_statistics
user_statistics_row_mapper::map_submission_statistics_row(
    ...
    statistics_value.infra_failure_submission_count =
        row_util::get_required<std::int64_t>(user_submission_statistics_row, 12);
    ...
    statistics_value.last_accepted_at_opt =
        row_util::get_optional<std::string>(user_submission_statistics_row, 14);
    statistics_value.updated_at = row_util::get_required<std::string>(user_submission_statistics_row, 15);
