...
std::expected<void, judge_error> submission_processor::process(
    ...
    if(!workspace_session_exp){
        return submission_lifecycle_.apply_completion(
            leased_submission_value,
            submission_completion_policy_.make_infra_failure_completion(
    ...
    auto submission_completion_value = [&]()
        ...
        if(!source_file_path_exp){
            return submission_completion_policy_.make_infra_failure_completion(
        ...
        auto build_completion_opt =
            submission_completion_policy_.make_build_completion(
                leased_submission_value,
                build_result_value
            );
        ...
        return submission_completion_policy_.make_decision_completion(
            leased_submission_value,
