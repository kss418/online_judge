...
std::expected<void, service_error> user_statistics_service::create_user_submission_statistics(
    db_connection& connection,
    std::int64_t user_id
){
    return db_service_util::map_error_to_service_error(
...
std::expected<void, service_error> user_statistics_service::ensure_user_submission_statistics(
    db_connection& connection,
    std::int64_t user_id
){
    return db_service_util::map_error_to_service_error(
...
std::expected<void, service_error> user_statistics_service::record_submission_created(
    db_connection& connection,
    std::int64_t user_id
){
    if(user_id <= 0){
...
std::expected<void, service_error> user_statistics_service::record_submission_status_transition(
    db_connection& connection,
    std::int64_t user_id,
